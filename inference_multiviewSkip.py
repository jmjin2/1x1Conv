...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='experiments/MultiviewSkipSR/net_g_15000.pth')
    parser.add_argument(
        '--input_path', type=str, default='datasets/MIV_val/MIVx4/(E02)Carpark/all_textures', help='input test image folder')
    parser.add_argument('--save_path', type=str, default='./results/skip_models/carpark/15000_15', help='save image path')
